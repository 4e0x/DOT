...
<head>
    ...
    <title>Cryptography Basic 1 Challenge | DOT APP v
        ...
        <div class="dot_app_root font_mono">
            ...
            <div class="dot_main_body" style="height:100vh;overflow:scroll;">
                ...
                <div class="dot_body_titles">
                    <h2 class="body_title dot_white font_monts">Cryptography Basic 1</h2>
                </div>
                <div class="dot_blank">
                    <div class="">
                        <div class="dot_blank">
                            <h3 class="font_mono dot_no_white dot_f14 l_h_1_4">A very basic and easy cipher(well not really), this challenge is the easiest of all.</h3>
                            <br>
                            <h3 class="font_mono dot_no_white dot_f14 l_h_1_4">1 - ?, 2 - ?, 3 - ? ...</h3>
                        </div>
                        <div class="dot_mt_2"><?php pushDotMessageInfo("This challenge requires no hint")?></div>
                        <div class="dot_blank dot_mt_2 dot_mb_2">
                           <h2 class="body_title_sub dot_white font_monts has_icon">3 25 18 20 16 15</h2>
                        </div>
                    </div>
                </div>
                <div class="dot_blank">
                    <div class="dot_blank dot_dbsetup_form dpanel_50">
                    <!-- What? im not giving hints all the time -->
                        <form class="dot_panels no_style" action="" method="POST">
                            <div class="dot_formgroup">
                                <label class="dot_formlabel font_mono dot_white">What is that word?</label>
                        ...
                        <?php 
                             if(isset($_POST['checkcipher'])){
                                ...
                                $the_actual_cipher = "crypto";
                                $the_user_cipher = strtolower($_POST['lcipher']);
                            
                                if(strcmp($the_actual_cipher,$the_user_cipher) !== 0){
                                    pushDotMessageError("Are you sure that's the word?");
                                }
                                else{
                                    pushDotMessageSuccess("CRACKED! See it was a very basic challenge.<br>......");
                                }
                            }
                        ?>
                    </div>
