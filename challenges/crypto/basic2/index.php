...
<head>
    ...
    <title>Cryptography Basic 2 Challenge | DOT APP v
        ...
        <div class="dot_app_root font_mono">
            ...
            <div class="dot_main_body" style="height:100vh;overflow:scroll;">
                ...
                <div class="dot_body_titles">
                    <h2 class="body_title dot_white font_monts">Cryptography Basic 2</h2>
                </div>
                <div class="dot_blank">
                    <div class="">
                        <div class="dot_blank">
                            <h3 class="font_mono dot_no_white dot_f14 l_h_1_4">Very well, this challenge involves frequency, mod & stuff.</h3>
                            <br>
                            <h3 class="font_mono dot_no_white dot_f14 l_h_1_4">Ché schiava di Roma</h3>
                        </div>
                        <div class="dot_mt_2"><?php pushDotMessageInfo("CIPHER RECEIVED:<br>DOULJKW,WKDWZDVHDVBLEHOLHYH")?></div>
                    ...
                    <div class="dot_blank dot_dbsetup_form dpanel_50">
                        ...
                        <?php 
                             if(isset($_POST['checkcipher'])){
                                ...
                                $the_actual_cipher = "alright,thatwaseasyibelieve";
                                $the_user_cipher = strtolower($_POST['lcipher']);
                                
                                if(strcmp($the_actual_cipher,$the_user_cipher) !== 0){
                                    pushDotMessageError("Good try, but no that's not the decrypted cipher.");
                                }
                                else{
                                    pushDotMessageSuccess("Woah! Click on related links to learn more.");
                                }
                            }
                        ?>
                    </div>
