...
<body class="dot_dashboard app-darkmode" id="dot_dashboard">
  <div class="dot_mb_2">
    ...
    <br>
    <h3 class="font_mono dot_no_white dot_f14 l_h_1_4">This particular kind has to do something with Italy.</h3>
  </div>
  <div class="">
    ...
    <h3 class="font_mono dot_no_white dot_f14 l_h_1_4 dot_mb_1">
      <?php 
          for($i=0;$i<16;$i++){
            echo "<em>Di Roma</em><br>";
          }
      ?>
    </h3>
    <?php 
          pushDotMessageInfo("This might help <a class='dot_links' href='https://cryptii.com/' target='_blank'>CRYPTII</a>.");
    ?>
    </div>
</body>