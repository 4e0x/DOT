...
<head>
    ...
    <title>Cryptography Basic 3 Challenge | DOT APP v
        ...
        <div class="dot_app_root font_mono">
            <aside class="dot_sidebar">
                ...
                <ul class="dot_options ul_nostyle">
                    ...
                    <ul id="crypt_levels" class="dot_options dot_submenu">
                            ...
                            <li class="dot_opt">
                                <a class="dot_menu dot_white" href="../basic4/">
                                Basic 4
                                </a>
                            </li>
            ...
            <div class="dot_main_body" style="height:100vh;overflow:scroll;">
                ...
                <div class="dot_body_titles">
                    <h2 class="body_title dot_white font_monts">Cryptography Basic 3</h2>
                </div>
                <div class="dot_blank">
                    <div class="">
                        <div class="dot_blank">
                            <h3 class="font_mono dot_no_white dot_f14 l_h_1_4">This challenge requires nothing at all. Just a snake.</h3>
                            <br>
                            <h3 class="font_mono dot_no_white dot_f14 l_h_1_4">~~~~</h3>
                        </div>
                        
                    </div>
                </div>
                <h3 class="body_title_sub dot_white font_monts has_icon">Download & run the python file in order to generate the key/cipher.</h3>
                <div class="dot_mt_2">
                    <a class="dot_formbutton dotbtn_default dot_white font_mono dot_f15" href="./py/crypto_modf25c9fa0a9026fb.py" download>Download</a>
                </div>            
                    ...
                    <div class="dot_blank dot_dbsetup_form dpanel_50">
                        <form class="dot_panels no_style" action="" method="POST">
                            <div class="dot_formgroup">
                                <label class="dot_formlabel font_mono dot_white">What is the generated cipher?</label>
                        ...
                        <?php 
                             if(isset($_POST['checkcipher'])){
                                ...
                                $the_actual_cipher = "dot_app_by_0x5a";
                                $the_user_cipher = strtolower($_POST['lcipher']);
                                
                                if(strcmp($the_actual_cipher,$the_user_cipher) !== 0){
                                    pushDotMessageError("Good try, but i believe that was not generated.");
                                }
                                else{
                                    pushDotMessageSuccess("Woooop! Hope you liked my mini py program.");
                                }
                            }
                        ?>
                    </div>
