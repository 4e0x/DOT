...
<head>
    ...
    <title>Cryptography Basic 4 Challenge | DOT APP v
        ...
        <div class="dot_app_root font_mono">
            <aside class="dot_sidebar">
                ...
                <ul class="dot_options ul_nostyle">
                    ...
                    <li class="dot_opt" id="crypt">
                        <a class="dot_menu dot_option_active dot_white">
						Cryptography
					</a>
                    <ul id="crypt_levels" class="dot_options dot_submenu">
                            <li class="dot_opt">
                                <a class="dot_menu dot_white " href="../basic1/">
                                Basic 1
                                </a>
                            </li>
                            <li class="dot_opt">
                            ...
                            <li class="dot_opt">
                                <a class="dot_menu dot_white" href="../basic3/">
                                Basic 3
                                </a>
                            </li>
                            <li class="dot_opt">
            ...
            <div class="dot_main_body" style="height:100vh;overflow:scroll;">
                ...
                <div class="dot_body_titles">
                    <h2 class="body_title dot_white font_monts">Cryptography Basic 4</h2>
                </div>
                <div class="dot_blank">
                    <div class="">
                        <div class="dot_blank">
                            <h3 class="font_mono dot_no_white dot_f14 l_h_1_4">This is a bit hard, well just a bit alright.</h3>
                            <br>
                            <h3 class="font_mono dot_no_white dot_f14 l_h_1_4">Might require some table as well. Remember "key" is the passphrase.</h3>
                        </div>
                        <div class="dot_mt_2"><?php pushDotMessageInfo("THERE WAS SOME RANDOM CIPHER WHICH GOES LIKE THIS:<br>GSYRVCKPEYSBSJWYYABEAUIBDLGCQYX.LMZIWYYJSOCNXFOGPITRYKPKTFIWCBMCC")?></div>
                    ...
                    <div class="dot_blank dot_dbsetup_form dpanel_50">
                        <form class="dot_panels no_style" action="" method="POST">
                            <div class="dot_formgroup">
                                <label class="dot_formlabel font_mono dot_white">What is the decrypted cipher?</label>
                                <input type="text" class="dot_formblock " title="Enter cipher" name="lcipher" id="lcipher" required>
                            </div>   
                            <div class="dot_formgroup">
                                <button class="dot_formbutton dotbtn_default dot_white font_mono dot_f15" name="checkcipher" id="checkcipher">Submit</button>
                            </div>
                        </form>
                        <!-- key is the passphrase/key if you are using cryptii to decrypt.-->
                        <?php 
                             if(isset($_POST['checkcipher'])){
                                 
                                $the_actual_cipher = strtolower("WOAHREALGOODIFYOUCRACKEDTHISMAN.HOPEYOULIKEDTHECRYPTOGRAPHYSERIES");
                                $the_user_cipher = strtolower($_POST['lcipher']);
                                
                                if(strcmp($the_actual_cipher,$the_user_cipher) !== 0){
                                    pushDotMessageError("Do not despair. Try again it will work.");
                                }
                                else{
                                    pushDotMessageSuccess("You are something really special! Good Work.");
                                }
                            }
                        ?>
                    </div>
