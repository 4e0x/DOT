...
<head>
    ...
    <title>Very Basic Challenge | DOT APP v
        ...
        <div class="dot_app_root font_mono">
            ...
            <div class="dot_main_body" style="height:100vh;overflow:scroll;">
                ...
                <div class="dot_body_titles">
                    <h2 class="body_title dot_white font_monts">Very Basic Challenge</h2>
                </div>
                <div class="dot_blank">
                    <div class="">
                        <div class="dot_blank">
                            <h3 class="font_mono dot_no_white dot_f14 l_h_1_4">This is a very basic challenge ever made. You don't need to think a lot just see it.</h3>
                            <br>
                            <h3 class="font_mono dot_no_white dot_f14 l_h_1_4">PS: I've seen a lot of internal reserved sites with such unwanted stuffs/bad web habits.</h3>
                        </div>
                ...
                <div class="dot_blank">
                    <div class="dot_blank dot_dbsetup_form dpanel_50">
                        <form class="dot_panels no_style" action="#" method="POST">
                            <!-- 
                                The password is : 0x5awashere
                                Never include comments related to sensitive information in websites.
                            -->
                            ...
                            <div class="dot_formgroup">
                                <button class="dot_formbutton dotbtn_default dot_white font_mono dot_f15" name="amiright" id="amiright">Am i right?</button>
                            </div>
                        </form>
                        <?php 
                             if(isset($_POST['amiright'])){
                                 
                                $the_actual_pass = "0x5awashere";
                                $the_user_pass = $_POST['lpass'];
                            
                                if(strcmp($the_actual_pass,$the_user_pass) !== 0){
                                    pushDotMessageError("Nice try but that's not the password i was looking for");
                                }
                                else{
                                    pushDotMessageSuccess("See it was that easy. This challenge was easiest of all to just get you hyped");
                                }
                            }
                        ?>
                    </div>
