...
<head>
    ...
    <title>Brute Force Challenge | DOT APP v
        ...
        <div class="dot_app_root font_mono">
            ...
            <div class="dot_main_body" style="height:100vh;overflow:scroll;">
                ...
                <div class="dot_body_titles">
                    <h2 class="body_title dot_white font_monts">Brute Force Challenge</h2>
                </div>
                <div class="dot_blank">
                    <div class="">
                        <div class="dot_blank">
                            <h3 class="font_mono dot_no_white dot_f14 l_h_1_4">The objective of this challenge is to brute force the login form below and try gaining access to other user's account.
                            <br>
                            This challenge can be completed in many ways, just use the right tool and it will "rock".</h3>
                         </div>
                    </div>
                </div>
                <div class="dot_blank dot_mt_2">
                    <div class="dot_blank dot_dbsetup_form dpanel_50">
                        <!--
                            Source: DVWA Vulnerability: Brute Force
                        -->
                        <form class="dot_panels no_style" action="#HYDRAITIS" method="POST">
                            <div class="dot_formgroup">
                              <h3 class="body_title_sub dot_white font_monts has_icon">Login</h3>
                              <h3 class="font_mono dot_no_white dot_f14 l_h_1_4">Enter your credentials below</h3>
                            </div>   
                            <div class="dot_formgroup">
                                <label class="dot_formlabel font_mono dot_white">Username</label>
                                <input type="text" class="dot_formblock " title="Enter username" name="luser" id="luser" required>
                            </div>
                            <div class="dot_formgroup">
                            ...
                            <div class="dot_formgroup">
                                <button class="dot_formbutton dotbtn_default dot_white font_mono dot_f15" name="doLogin" id="doLogin">Login</button>
                            </div>
                        </form>
                        <?php 
                             // Difficulty set to medium according to DVWA
                             ...
                             if(isset($_POST['doLogin'])){
                                ...
                                if( $result && mysql_num_rows( $result ) == 1 ) {
                                    ...
                                    // Voila! We are in
                                    pushDotMessageSuccess("We are in. Welcome to the protected area {$user}");
                                }
                                else {
                                    // Wait. Try again
                                    sleep(rand( 0, 4));
                    ...
                    <div id="dot_mt_2">
                        <?php 
                          pushDotMessageSuccess("Source: DVWA Vulnerability: Brute Force <a class='dot_links' href='http://www.dvwa.co.uk' target='_blank'>Check It Out</a>.")
                        ?>
                    </div>
