...
<body class="dot_dashboard app-darkmode" id="dot_dashboard">
  ...
  <div class="">
    ...
    <h3 class="font_mono dot_no_white dot_f14 l_h_1_4 dot_mb_2">Find the hidden text just that it's bit lengthy kind of a hunt</h3>
    <h3 class="font_mono dot_no_white dot_f14 l_h_1_4 dot_mb_1">
      <?php 
          for($i=0;$i<8;$i++){
            echo "<em>Searching Stuff...</em><br>";
          }
      ?>
    </h3>
    <?php 
          pushDotMessageInfo("See some tools here <a class='dot_links' href='https://0xrick.github.io/lists/stego/' target='_blank'>0XRICK</a>.");
    ?>
    </div>
</body>