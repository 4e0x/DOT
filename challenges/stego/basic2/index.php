<!-- 
  fS6n740bjYc7
https://cryptopaste.org/WZ8Rg7bw
-->
<?php 
   session_start();
...
<head>
    ...
    <title>Stego Basic 2 Challenge | DOT APP v
        ...
        <div class="dot_app_root font_mono">
            ...
            <div class="dot_main_body" style="height:100vh;overflow:scroll;">
                ...
                <div class="dot_body_titles">
                    <h2 class="body_title dot_white font_monts">Stego Basic 2</h2>
                </div>
                <div class="dot_blank">
                    <div class="">
                        <div class="dot_blank">
                            <h3 class="font_mono dot_no_white dot_f14 l_h_1_4">The last stego challenge to complete.</h3>
                            <br>
                            <h3 class="font_mono dot_no_white dot_f14 l_h_1_4">A bit lengthy don't you think?</h3>
                            <div class="dot_mt_2">
                            <?php pushDotMessageInfo("The passphrase would be fS6n740bjYc7"); ?>
                            </div>
                        </div>
                        <div class="dot_mt_2">
                            <img class="stego_b1" src="../../../assets/images/Egyptian.jpg" alt="?">
                        </div>
                    ...
                    <div class="dot_blank dot_dbsetup_form dpanel_50">
                        <form class="dot_panels no_style" action="" method="POST">
                            <div class="dot_formgroup">
                                <label class="dot_formlabel font_mono dot_white">What text did you find?</label>
                        ...
                        <?php 
                             if(isset($_POST['checktext'])){
                                ...
                                $the_actual_hiddentext = "do_contribute_to_dot";
                                $the_user_text = $_POST['ltext'];
                                
                                if(strcmp($the_actual_hiddentext,$the_user_text) !== 0){
                                    pushDotMessageError("It's a bit complicated. Try again.");
                                }
                                else{
                                    pushDotMessageSuccess("Voila! You've completed the stego challenge.");
                                }
                            }
                        ?>
                    </div>
